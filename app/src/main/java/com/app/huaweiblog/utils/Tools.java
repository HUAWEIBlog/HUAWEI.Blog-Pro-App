...
import com.app.huaweiblog.plus.ActivityWebView;
...
import com.app.huaweiblog.plus.model.Attachment;
import com.app.huaweiblog.plus.model.Category;
import com.app.huaweiblog.plus.model.Author;
import com.app.huaweiblog.plus.model.DeviceInfo;
import com.app.huaweiblog.plus.model.Page;
import com.app.huaweiblog.plus.model.Post;
import com.app.huaweiblog.plus.realm.table.AuthorRealm;
...
public class Tools {
    ...
    public static void aboutAction(Activity activity) {
        ...
        int padding = Tools.dip2px(activity, 20);
    ...
    public static void methodShare(Activity act, Post p) {
        try {
            ...
            sb.append("Lese den Artikel \'" + p.title_plain + "\'\n");
            sb.append("Quelle : " + p.url + "\n");
            sb.append("Geteilt über die Android-App \'" + act.getString(R.string.appName) + "\'");

            Intent sharingIntent = new Intent(Intent.ACTION_SEND);
            sharingIntent.setType("text/plain");

            sharingIntent.putExtra(Intent.EXTRA_SUBJECT, act.getString(R.string.appName));
    ...
    public static String getAuthorTxt(List<Author> authors) {
        String res = "";
