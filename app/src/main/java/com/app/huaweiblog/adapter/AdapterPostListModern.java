...
public class AdapterPostListModern extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterPostListModern(Context context, RecyclerView view, List<Post> items) {
        this.items = items;
        ctx = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_post_modern, parent, false);
