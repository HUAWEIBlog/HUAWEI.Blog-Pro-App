...
public class ActivityCategorySoftwareDetails extends AppCompatActivity {

    public static final String EXTRA_OBJC = "key.EXTRA_OBJC";

    // give preparation animation activity transition
    public static void navigate(AppCompatActivity activity, View transitionView, Category obj) {
        Intent intent = new Intent(activity, ActivityCategorySoftwareDetails.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new AdapterPostListModern.OnItemClickListener() {
            ...
            public void onItemClick(View v, Post obj, int position) {
                ActivityPostDetails.navigate( ActivityCategorySoftwareDetails.this, v.findViewById(R.id.image), obj);
            }
        });
        ...
        // analytics tracking
        ThisApplication.getInstance().trackScreenView("View category : Software");
    }
    ...
    private void initToolbar() {
        ...
        actionBar.setTitle(Html.fromHtml("Software"));
    }
