...
import com.app.huaweiblog.plus.data.GDPR;
import com.app.huaweiblog.plus.data.SharedPref;
import com.app.huaweiblog.plus.fragment.FragmentCategory;
import com.app.huaweiblog.plus.fragment.FragmentHome;
import com.app.huaweiblog.plus.fragment.FragmentLater;
import com.app.huaweiblog.plus.fragment.FragmentPage;
...
public class ActivityMain extends AppCompatActivity {
    ...
    private void initDrawerMenu() {
        ...
        if (AppConfig.HIDE_PROFILE_VIEW) {
            ((View) navigationView.getHeaderView(0).findViewById(R.id.lyt_profile)).setVisibility(View.GONE);
        }
    }
    ...
    public void displayFragment(int id, String title) {
        ...
        switch (id) {
            ...
            case R.id.nav_devices:
                Intent intent_d = new Intent(this, ActivityCategoryDevicesDetails.class);
            ...
            case R.id.nav_enterprise:
                ...
                break;
            case R.id.nav_tipps:
                Intent intent_t = new Intent(this, ActivityCategoryTippsDetails.class);
