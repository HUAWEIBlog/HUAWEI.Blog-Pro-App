...
public class ActivityCategoryEnterpriseDetails extends AppCompatActivity {

    public static final String EXTRA_OBJC = "key.EXTRA_OBJC";

    // give preparation animation activity transition
    public static void navigate(AppCompatActivity activity, View transitionView, Category obj) {
        Intent intent = new Intent(activity, ActivityCategoryEnterpriseDetails.class);
    ...
    private String category = "enterprise";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new AdapterPostListModern.OnItemClickListener() {
            ...
            public void onItemClick(View v, Post obj, int position) {
                ActivityPostDetails.navigate( ActivityCategoryEnterpriseDetails.this, v.findViewById(R.id.image), obj);
            }
        });
        ...
        // analytics tracking
        ThisApplication.getInstance().trackScreenView("View category : Enterprise");
    }
    ...
    private void initToolbar() {
        ...
        actionBar.setTitle(Html.fromHtml("Enterprise"));
    }
    ...
    private void requestPostApi(final long page_no) {
        ...
        callbackCall = api.getCategoryDetailsByPage(1931, page_no, Constant.POST_PER_REQUEST);
