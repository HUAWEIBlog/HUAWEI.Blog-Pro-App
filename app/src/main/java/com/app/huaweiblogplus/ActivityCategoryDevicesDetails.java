...
public class ActivityCategoryDevicesDetails extends AppCompatActivity {

    public static final String EXTRA_OBJC = "key.EXTRA_OBJC";

    // give preparation animation activity transition
    public static void navigate(AppCompatActivity activity, View transitionView, Category obj) {
        Intent intent = new Intent(activity, ActivityCategoryDevicesDetails.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new AdapterPostListModern.OnItemClickListener() {
            ...
            public void onItemClick(View v, Post obj, int position) {
                ActivityPostDetails.navigate( ActivityCategoryDevicesDetails.this, v.findViewById(R.id.image), obj);
            }
        });
        ...
        // analytics tracking
        ThisApplication.getInstance().trackScreenView("View category : Smartphones");
    }
    ...
    private void initToolbar() {
        ...
        actionBar.setTitle(Html.fromHtml("Smartphones"));
    }
    ...
    private void requestPostApi(final long page_no) {
        ...
        callbackCall = api.getCategoryDetailsByPage(15, page_no, Constant.POST_PER_REQUEST);
