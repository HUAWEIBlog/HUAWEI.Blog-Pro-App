...
import com.app.huaweiblogplus.plus.connection.callbacks.CallbackTagsDetails;
...
public class ActivityCategoryPreferences extends AppCompatActivity {

    public static final String EXTRA_OBJC = "key.EXTRA_OBJC";

    // give preparation animation activity transition
    public static void navigate(AppCompatActivity activity, View transitionView, Category obj) {
        Intent intent = new Intent(activity, ActivityCategoryPreferences.class);
    ...
    private Call<CallbackTagsDetails> callbackCall = null;

    private String category = "Lieblingsgerät";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new AdapterPostListModern.OnItemClickListener() {
            ...
            public void onItemClick(View v, Post obj, int position) {
                ActivityPostDetails.navigate( ActivityCategoryPreferences.this, v.findViewById(R.id.image), obj);
            }
        });
        ...
        // analytics tracking
        ThisApplication.getInstance().trackScreenView("View category : Lieblingsgerät");
    }
    ...
    private void initToolbar() {
        ...
        actionBar.setTitle(Html.fromHtml("Lieblingsgerät"));
    }
    ...
    private void requestPostApi(final long page_no) {
        ...
        callbackCall = api.getTagDetailsByPage(  sharedPref.getSmartphone(), page_no, Constant.POST_PER_REQUEST);
        callbackCall.enqueue(new Callback<CallbackTagsDetails>() {
            @Override
            public void onResponse(Call<CallbackTagsDetails> call, Response<CallbackTagsDetails> response) {
                CallbackTagsDetails resp = response.body();
            ...
            @Override
            public void onFailure(Call<CallbackTagsDetails> call, Throwable t) {
