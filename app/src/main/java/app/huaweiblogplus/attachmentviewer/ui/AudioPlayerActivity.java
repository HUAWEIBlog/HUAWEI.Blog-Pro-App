...
public class AudioPlayerActivity extends AppCompatActivity implements MediaController.MediaPlayerControl {
    ...
    private app.huaweiblogplus.attachmentviewer.MusicService MusicService;
    ...
    protected void onResume() {
        super.onResume();
        //bind to service
        MusicServiceIntent = new Intent(this, app.huaweiblogplus.attachmentviewer.MusicService.class);
    ...
    private final class MusicServiceServiceConnection implements ServiceConnection {
        public void onServiceConnected(ComponentName className, IBinder baBinder) {
            ...
            MusicService = ((app.huaweiblogplus.attachmentviewer.MusicService.MusicServiceBinder) baBinder).getService();
