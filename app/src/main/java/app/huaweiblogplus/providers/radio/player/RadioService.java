...
import app.huaweiblogplus.providers.radio.metadata.ShoutcastDataSourceFactory;
import app.huaweiblogplus.providers.radio.metadata.ShoutcastMetadataListener;
import app.huaweiblogplus.R;
import app.huaweiblogplus.providers.radio.RadioStream;
import app.huaweiblogplus.providers.radio.StaticEventDistributor;
import app.huaweiblogplus.providers.radio.parser.AlbumArtGetter;
...
public class RadioService extends Service implements Player.EventListener, AudioManager.OnAudioFocusChangeListener, ShoutcastMetadataListener {
    ...
    public static final String ACTION_PLAY = "app.huaweiblogplus.radio.ACTION_PLAY";
    public static final String ACTION_PAUSE = "app.huaweiblogplus.radio.ACTION_PAUSE";
    public static final String ACTION_STOP = "app.huaweiblogplus.radio.ACTION_STOP";
