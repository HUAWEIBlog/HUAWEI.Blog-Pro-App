...
import app.huaweiblogplus.attachmentviewer.ui.AttachmentActivity;
import app.huaweiblogplus.comments.CommentsActivity;
import app.huaweiblogplus.providers.Provider;
import app.huaweiblogplus.providers.fav.FavDbAdapter;
...
import app.huaweiblogplus.providers.wordpress.api.providers.JetPackProvider;
import app.huaweiblogplus.providers.wordpress.api.providers.RestApiProvider;
import app.huaweiblogplus.util.DetailActivity;
import app.huaweiblogplus.util.Helper;
import app.huaweiblogplus.util.Log;
import app.huaweiblogplus.util.WebHelper;
...
public class WordpressDetailActivity extends DetailActivity implements JsonApiPostLoader.BackgroundPostCompleterListener {
    ...
    private void shareContent() {
        ...
        url = url.replace("https://apiv2.huaweiblog.de","https://www.huaweiblog.de");
        Intent sendIntent = new Intent();
        sendIntent.setAction(Intent.ACTION_SEND);
        sendIntent.putExtra(Intent.EXTRA_TEXT, post.getTitle() + "\n\nvon HUAWEI.Blog geteilt mit der Huawei News App \n" + url);
    ...
    public void setHTML(String source) {
        ...
        html = html.replace("https://apiv2.huaweiblog.de","https://www.huaweiblog.de");

        // log out the pure shown html website - TODO: - [modula id=“53458″]
        Log.e("HTML", "Website:" + html);
