...
import app.huaweiblogplus.providers.wordpress.api.WordpressCategoriesTask;
import app.huaweiblogplus.providers.wordpress.api.WordpressGetTaskInfo;
import app.huaweiblogplus.providers.wordpress.api.WordpressPostsTask;
...
public class RestApiProvider implements WordpressProvider {
    ...
    @Override
    public String getTagPostsArray(WordpressGetTaskInfo info, Set<String> tag) {
        StringBuilder builder = new StringBuilder();
        builder.append(info.baseurl);
        builder.append("posts/?per_page=");
        if (info.simpleMode)
