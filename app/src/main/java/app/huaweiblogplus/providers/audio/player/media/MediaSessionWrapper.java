package app.huaweiblogplus.providers.audio.player.media;
...
import app.huaweiblogplus.providers.audio.player.remote.RemoteControlClientCompat;
import app.huaweiblogplus.providers.audio.player.remote.RemoteControlHelper;
...
public class MediaSessionWrapper {
     ...
     */
    static final String ACTION_TOGGLE_PLAYBACK = "app.huaweiblogplus.providers.soundcloud.library.media.TOGGLE_PLAYBACK";

    /**
     * Action used to catch broadcast from {@link .MediaSessionReceiver}
     */
    static final String ACTION_NEXT_TRACK = "sherdle.huawei.soundcloud.library.media.NEXT_TRACK";

    /**
     * Action used to catch broadcast from {@link MediaSessionReceiver}
     */
    static final String ACTION_PREVIOUS_TRACK = "app.huaweiblogplus.providers.soundcloud.library.media.PREVIOUS_TRACK";
