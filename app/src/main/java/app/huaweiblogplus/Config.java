...
public class Config {
    ...
    public static final String NOTIFICATION_BASEURL = "https://www.huaweiblog.de/";
    ...
    //If ads are enabled, also show them on the HOLDER layout
    public static final boolean ADMOB_HOLDER = false;
    //If ads are enabled, also show them on the RSS layout
    public static final boolean ADMOB_RSS = false;
    //If ads are enabled, also show them on the in comments layout
    public static final boolean ADMOB_COMMENTS = false;
    //If ads are enabled, also show them on the attachments layout
    public static final boolean ADMOB_ATTACHMENT = false;
    //If ads are enabled, also show them on the Main layout
    public static final boolean ADMOB_MAIN = false;
    //If ads are enabled, also show them on the product layout
    public static final boolean ADMOB_PRODUCT = false;
    //If ads are enabled, also show them on the wordpress layout
    public static final boolean ADMOB_WORDPRESS = false;
